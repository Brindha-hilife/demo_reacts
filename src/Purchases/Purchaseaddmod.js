...
function Purchasesearchmod() {
    ...
    const [purchaseSearch, setPurchaseSearch] = useState({
        purchaseSearchname: "", purchaseSearchsku: "", purchaseSearchbarcode: "", purchaseSearchunit: "",
        purchaseSearchbrand: "", purchaseSearchcategory: "", purchaseSearchsubcat: "", purchaseSearchbusinessloc: "",
        purchaseSearchalert: "", purchaseSearchapplicable: "", purchaseSearchsellingtax: "", purchaseSearchproducttype: "",
        purchaseSearchexc: "", purchaseSearchinc: "", purchaseSearchmarg: "", purchaseSearchexctax: "", purchaseSearchinctax: "",
    ...
    return (
        <Box>
            <Box>
                <Grid sx={sellStyle.spanIcons} ><FaPlus onClick={purchasePlusOpen} /></Grid>
            </Box>
            ...
            <form action=''>
                <BootstrapDialog
                    ...
                    maxWidth="lg"
                >
                    <BootstrapDialogTitle id="customized-dialog-title1" onClose={purchasePlusClose}>
                        Add new product
                                        ...
                                        <Table aria-label="simple table " sx={{ borderBlock: '1px solid #b97fd0' }} fullWidth>
                                            <TableHead fullWidth>
                                                <TableRow fullWidth>
                                                    ...
                                                    <TableCell sx={sellStyle.tableHd} align="center" fullWidth>Default Selling Price</TableCell>
                                                </TableRow>
                                            </TableHead>
                                            <TableBody fullWidth>
                                ...
                                <Grid item md={12} sm={12} xs={12} >
                                    ...
                                    <TableContainer component={Paper} fullWidth>
                                        <Table aria-label="simple table " sx={{ borderBlock: '1px solid #b97fd0' }} fullWidth>
                                            <TableHead fullWidth >
                                                <TableRow fullWidth>
                                                    <TableCell sx={sellStyle.tableHd} align="center" fullWidth>Location</TableCell>
                                                    <TableCell sx={sellStyle.tableHd} align="center" fullWidth>Quantity</TableCell>
                                                    <TableCell sx={sellStyle.tableHd} align="center" fullWidth>Unit Cost (Before Tax)</TableCell>
                                                    <TableCell sx={sellStyle.tableHd} align="center" fullWidth>Subtotal (Before Tax)</TableCell>
                                                </TableRow>
                                            </TableHead>
                                            <TableBody fullWidth>
                                                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }} fullWidth>
