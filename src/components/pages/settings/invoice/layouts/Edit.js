...
return(
<Box>
    <Typography  sx={userStyle.HeaderText}>Edit new invoice layout</Typography>
    ...
    <Box sx={userStyle.container}>
        ...
        <Box sx={{textAlign:'center'}}>
            <Button variant='contained' sx={{backgroundColor:'#7009ab'}}>UPDATE</Button>
        </Box>
</Box>
);
