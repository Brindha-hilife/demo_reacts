...
import {
    ...
    Typography, Button, Table, Tooltip, IconButton, TableContainer, TableHead, TableRow, TableBody, TableFooter,
} from '@mui/material';
...
const StockAdjust = () => {
    ...
    const [stockAdjAdd, setStockAdjAdd] = useState({
        stockAdjAddRefNo: "", stockAdjAddAdjType: "", stockAdjAddDate: "",
        stockAdjAddSearch: "", stockAdjAddtotalAmount: "", stockAdjAddReason: "", stockAdjAddBusiLoc: "",
    });
    ...
    return (
        <Box>
            <form action=''>
                <Box>
                    <Grid display="flex">
                        <Typography sx={userStyle.HeaderText}>Add Stock Adjustment</Typography>&ensp;
                    </Grid>
                </Box>
                    ...
                    <Grid container spacing={3} sx={{ padding: '40px 20px', }}>
                        <Grid item md={3} sm={6} xs={12}>
                            <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                ...
                                <Select
                                    ...
                                    onChange={(e) => { setStockAdjAdd({ ...stockAdjAdd, stockAdjAddBusiLoc: e.target.value }) }}
                        ...
                        <Grid item md={3} sm={6} xs={12} >
                            <FormControl size="small" fullWidth >
                                ...
                                <OutlinedInput
                                    id="component-outlined"
                                    value={stockAdjAdd.stockAdjAddDate}
                                    onChange={(e) => { setStockAdjAdd({ ...stockAdjAdd, stockAdjAddDate: e.target.value }) }}
                                    label="Sale Date *"
                                    type='date'
                                />
                            </FormControl>
                        ...
                        <Grid item md={3} sm={6} xs={12} >
                            <Grid sx={{ display: 'flex' }}  >
                                ...
                                <Grid>
                                    <Tooltip classes={{ arrow: classes.arrow, tooltip: classes.tooltip }} title="Norma: Adjustment for normal reasons like Leakage, Damage etc. 
                      Abnormal: Adjustment for reasons like Fire, Accident etc." arrow>
                                        <IconButton>
                                            <FcInfo />
                                        </IconButton>
                                    </Tooltip>
                                        ...
                                        <Tooltip classes={{ arrow: classes.arrow, tooltip: classes.tooltip }} arrow title="Amountt recovered from insurance or selling of scraps or others.">
                                            <InputAdornment position="end">
                                                <IconButton
                                                    ...
                                                    value={stockAdjAdd.stockAdjAddtotalAmount}
                                                    onChange={(e) => { setStockAdjAdd({ ...stockAdjAdd, stockAdjAddtotalAmount: e.target.value }) }}
                                                    edge="end"
                                                >
                                                    <FcInfo />
                                                </IconButton>
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={6}>
                            ...
                            <FormControl size="small" fullWidth >
                                <TextareaAutosize aria-label="minimum height" minRows={3} style={{ border: '1px solid #b97df0' }}
                                    value={stockAdjAdd.stockAdjAddReason}
                                    onChange={(e) => { setStockAdjAdd({ ...stockAdjAdd, stockAdjAddReason: e.target.value }) }} />
                            </FormControl>
                        </Grid>
                    </Grid><br />
                    <Box sx={{ float: 'right' }}>
