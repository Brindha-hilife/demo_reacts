...
const StockTransfer = () => {
    ...
    const [stockTranAdd, setStockTranAdd] = useState({
        ...
        stockTranAddSearch: "", stockTranAddShipChrg: "", stockTranAddAddNote: "", stockTranAddDate: "",
    });
    ...
    return (
        <Box>
            <form action=''>
                <Box>
                    <Grid display="flex">
                        <Typography sx={userStyle.HeaderText}>Add Stock Transfer</Typography>
                    </Grid>
                </Box>
                    ...
                    <Grid container spacing={3} sx={{ padding: '40px 20px', }}>
                        <Grid item md={4} sm={12} xs={12} >
                            <FormControl size="small" fullWidth >
                                ...
                                <OutlinedInput
                                    id="component-outlined" label="Sale Date *"
                                    type='date'
                                    value={stockTranAdd.stockTranAddDate}
                                    onChange={(e) => { setStockTranAdd({ ...stockTranAdd, stockTranAddDate: e.target.value }) }}
                        ...
                        <Grid item md={4} sm={12} xs={12} >
                            <Grid sx={{ display: 'flex' }}  >
                                ...
                                <Grid>
                                    <Tooltip classes={{ arrow: classes.arrow, tooltip: classes.tooltip }} title="Stock transfer will not be editable if status is completed " arrow>
                                        <IconButton>
                                            <FcInfo />
                                        </IconButton>
                                    </Tooltip>
