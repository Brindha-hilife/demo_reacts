        ...
        <form action=''>
            ...
            <Box sx={userStyle.container}>
                ...
                <Grid container spacing={3} sx={userStyle.textInput}>
                    ...
                    <Grid item md={4} sm={6} xs={12}>
                        <Grid sx={{ display: 'flex' }}  >
                            ...
                            <FormControl size="small" fullWidth >
                                ...
                                <OutlinedInput
                                    id="component-outlined"
                                    value={draftAdd.draftAddAmt}
                                    onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddAmt: e.target.value }) }}
                                    label="Amount *"
                                    type='number'
                                />
                            </FormControl>
                        ...
                        <Grid sx={{ display: 'flex' }}  >
                            ...
                            <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                ...
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={draftAdd.draftAddPayMethod}
                                    onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddPayMethod: e.target.value }) }}
                    ...
                    {(draftAdd.draftAddPayMethod ==='Cash' || draftAdd.draftAddPayMethod ==='Other' || draftAdd.draftAddPayMethod ==='Advance') &&
                    (
                        <>
                                ...
                                <Grid sx={{ display: 'flex' }}  >
                                    ...
                                    <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                        ...
                                        <Select
                                            labelId="demo-select-small"
                                            id="demo-select-small"
                                            value={draftAdd.draftAddPayAcc}
                                            onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddPayAcc: e.target.value }) }}
                    ...
                    {/* ****** Dropdown options ****** */}
                    {/* ****** Card Section ****** */}
                    {draftAdd.draftAddPayMethod ==='Card' &&
                    (
                        <>
                            <Grid item md={4} sm={6} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddCrdNo}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddCrdNo: e.target.value }) }}
                                        label="Card Number"
                                        type='text'
                                    />
                                </FormControl>
                            ...
                            <Grid item md={4} sm={6} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddCrdName}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddCrdName: e.target.value }) }}
                            ...
                            <Grid item md={4} sm={6} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddCrdTransNo}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddCrdTransNo: e.target.value }) }}
                            ...
                            <Grid item md={3} sm={12} xs={12}>
                                <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                    ...
                                    <Select
                                        labelId="demo-select-small"
                                        id="demo-select-small"
                                        value={draftAdd.draftAddCrdType}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddCrdType: e.target.value }) }}
                                        label="Card Type"
                                        fullWidth
                                    >
                            ...
                            <Grid item md={3} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddMonth}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddMonth: e.target.value }) }}
                                        label="Month"
                                        type='text'
                                    />
                                </FormControl>
                            ...
                            <Grid item md={3} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddYear}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddYear: e.target.value }) }}
                                        label="Year"
                                        type='text'
                                    />
                                </FormControl>
                            ...
                            <Grid item md={3} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddSecCode}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddSecCode: e.target.value }) }}
                                        label="Security Code"
                                        type='text'
                                    />
                                </FormControl>
                    ...
                    {/* ****** Cheque Section ****** */}
                    {draftAdd.draftAddPayMethod ==='Cheque' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddChequeNo}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddChequeNo: e.target.value }) }}
                                        label="Cheque No."
                                        type='text'
                                    />
                                </FormControl>
                    ...
                    {/* ****** Bank Section ****** */}
                    {draftAdd.draftAddPayMethod ==='Bank Transfer' &&
                    (
                        <>
                    <Grid item md={12} sm={12} xs={12}>
                        <FormControl size="small" fullWidth >
                            ...
                            <OutlinedInput
                                id="component-outlined"
                                value={draftAdd.draftAddBankAccNo}
                                onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddBankAccNo: e.target.value }) }}
                    ...
                    {/* ****** Transaction Section ****** */}
                    {draftAdd.draftAddPayMethod ==='Custom Payment 1' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                                    ...
                                    <OutlinedInput
                                        id="component-outlined"
                                        value={draftAdd.draftAddTrans}
                                        onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddTrans: e.target.value }) }}
                    ...
                    {draftAdd.draftAddPayMethod ==='Custom Payment 2' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                     ...
                     {draftAdd.draftAddPayMethod ==='Custom Payment 3' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                    ...
                    {draftAdd.draftAddPayMethod ==='Custom Payment 4' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                    ...
                    {draftAdd.draftAddPayMethod ==='Custom Payment 5' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                    ...
                    {draftAdd.draftAddPayMethod ==='Custom Payment 6' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                    ...
                    {draftAdd.draftAddPayMethod ==='Custom Payment 7' &&
                    (
                        <>
                            <Grid item md={12} sm={12} xs={12}>
                                <FormControl size="small" fullWidth >
                    ...
                    <Grid item md={12} sm={12} xs={12}>
                        ...
                        <FormControl size="small" fullWidth >
                            <TextareaAutosize aria-label="minimum height" minRows={3} style={{ border: '1px solid #b97df0' }}
                                value={draftAdd.draftAddPayNote}
                                onChange={(e) => { setDraftAdd({ ...draftAdd, draftAddPayNote: e.target.value }) }} />
                        </FormControl><br /><br />
                        <hr />
                    </Grid>
