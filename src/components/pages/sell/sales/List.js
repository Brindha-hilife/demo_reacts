        ...
        <Box>
            ...
            <Box sx={userStyle.container}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={4}>
                        <Link to="/sell/salescreate" style={{ textDecoration: 'none', color: 'white' }}><Button sx={userStyle.buttonadd} >ADD</Button></Link>
                    </Grid>
                </Grid>
                                    ...
                                    <StyledTableCell component="th" scope="row">
                                        <div>
                                            ...
                                            >
                                                ...
                                                <MenuItem onClick={handleClose} disableRipple><EditOutlinedIcon style={{fontSize:'large'}}/>&ensp;Edit&ensp;</MenuItem>
