...
function Draftslist() {
    ...
    return (
        <Box>
            <Typography variant="h5" sx={sellStyle.UnitHeaderText}>Drafts</Typography>
            ...
            <Box sx={sellStyle.container}>
                <Grid container spacing={2}>
                    <Grid item xs={8}></Grid>
                    <Grid item xs={4}>
                        <Button sx={sellStyle.buttonAdd} ><Link to="/" style={{ textDecoration: 'none', color: 'white' }}> Add Drafts</Link></Button>
                    </Grid>
                </Grid>
