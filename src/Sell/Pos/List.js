...
import { Box, Button, Grid, Menu, Divider, Typography, FormGroup, FormControlLabel, Checkbox, FormControl, InputLabel, Select, MenuItem, OutlinedInput, Table, TableBody, TableCell, tableCellClasses, TableContainer, TableHead, TableRow, TableFooter, Paper } from '@mui/material';
...
function Poslist() {
    ...
    return (
        <Box>
            <Typography variant="h5" sx={sellStyle.UnitHeaderText}>POS</Typography>
                                ...
                                <Grid item md={3} sm={12} xs={12}>
                                    <FormControl size="small" fullWidth>
                                        ...
                                        <OutlinedInput
                                            ...
                                            value={posForm.posFormDate}
                                            onChange={(e) => { setPosForm({ ...posForm, PosFormDate: e.target.value }) }}
                                            label=""
                                            type="date"
                                        />
                                    </FormControl>
            ...
            <Box sx={sellStyle.container}>
                <Grid container spacing={2}>
                    <Grid item xs={8}>
                        <Typography sx={sellStyle.boxheadertxt}>List POS</Typography>
                    </Grid>
                    <Grid item xs={4}>
